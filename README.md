...
<ul dir=“auto”>
<li><strong>Testing Tools:</strong> Postman, Swagger, Cypress with JavaScript, VS Code, Git, GitHub. 
<li><strong>Test Management & Defect Tracking:</strong> JIRA, Zephyr Scale, TestRail, Qase.io, Azure DevOps. 
<li><strong>Databases and Tools:</strong> SQL, PostgreSQL, MySQL, DBeaver. 
<li><strong>Web Technologies:</strong> HTML, CSS. 
<li><strong>Mobile Testing:</strong> TestFlight, Android Studio. 
<li><strong>Cloud Technologies:</strong> AWS OpenSearch.
